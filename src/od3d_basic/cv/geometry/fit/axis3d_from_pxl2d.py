...
import torch
from od3d_basic.cv.geometry.transform import reproj2d3d_broadcast
from od3d_basic.cv.geometry.transform import rot3x3
from od3d_basic.cv.geometry.transform import so3_exp_map
...
def axis3d_from_pxl2d(kpts2d_orient, cam_intr4x4):
    ...
    from od3d_basic.cv.geometry.transform import so3_log_map
