...
from od3d_basic.cv.geometry.transform import transf3d_broadcast, inv_tform4x4, tform4x4
import open3d
import torch
from typing import Union, List
from od3d_basic.cv.visual.show import get_engine_geometries_for_cams
from od3d_basic.cv.geometry.downsample import random_sampling, random_sampling_with_fill
from pathlib import Path
import numpy as np

def label_kpts4d(fpaths_meshs: List[Path], fpaths_kpts4d: List[Path],):

    from od3d_basic.cv.geometry.objects3d.meshes.meshes import Meshes
    ...
    for obj_label_id in range(len(fpaths_meshs)):
        ...
        if len(scene_kpts3d_picked_ids) > 0:
            ...
            from od3d_basic.cv.io import write_tensor
